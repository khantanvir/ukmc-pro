                    ...
                    <div class="statbox widget box box-shadow">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-3">
                                    <div class="form-group mb-2"><label for="exampleFormControlInput1">Change Status*</label>
                                        <select data-id="{{ $task_data->id }}" data-action="{{ URL::to('agent-task-status-chnage') }}" name="status" class="task-status-change form-control" onchange="task_status_change()">
                        ...
                        <div>
                            <h5 class="mb-5">Comments <span class="comment-count">({{ (!empty($coments))?count($coments):'0' }})</span></h5>
                                    ...
                                    @if(Auth::user()->role=='agent' && Auth::user()->is_admin==1 || Auth::user()->id==$task_data->assign_to)
                                    <div class="post-form mt-5">
                                        <div class="section add-comment">
                                            <div class="info">
                                                <form action="{{ URL::to('agent-task-coment-store') }}" method="post" enctype="multipart/form-data">
                                                @csrf

...
<div class="layout-px-spacing">
    <div class="middle-content container-xxl p-0">
        ...
        <h5 class="pt-3">Application Details</h5>
                                ...
                                <div id="defaultStep-one" class="content" role="tabpanel">
                                    <form>
                                        <div class="form-group mb-4">
                                            ...
                                            <input disabled type="text" class="form-control" id="defaultForm-name">
                                        </div>
                                    </form>
                                ...
                                <div id="defaultStep-two" class="content" role="tabpanel">
                                    <form>
                                        <div class="form-group mb-4">
                                            ...
                                            <input disabled type="email" class="form-control" id="defaultEmailAddress">
                                        </div>
                                    </form>
                                ...
                                <div id="defaultStep-three" class="content" role="tabpanel">
                                    <form class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <input disabled type="text" class="form-control" id="defaultInputAddress" placeholder="1234 Main St">
                                        </div>
                                        <div class="col-12">
                                            <label for="defaultInputAddress2" class="form-label">Address
                                                2</label>
                                            <input disabled type="text" class="form-control" id="defaultInputAddress2" placeholder="Apartment, studio, or floor">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="defaultInputCity" class="form-label">City</label>
                                            <input disabled type="text" class="form-control" id="defaultInputCity">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="defaultInputState" class="form-label">State</label>
                                            <select disabled id="defaultInputState" class="form-select">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input disabled type="text" class="form-control" id="defaultInputZip">
                                        </div>
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="checkbox" id="defaultGridCheck">
                            ...
                            <div class="bs-stepper-content">
                                <div id="verticalFormStep-one" class="content" role="tabpanel">
                                    ...
                                    <form>
                                        <div class="form-group mb-4">
                                            ...
                                            <input disabled type="text" class="form-control" id="verticalFormStepform-name" placeholder="Agent/ Referrel name">
                                        </div>
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input disabled type="radio" id="customRadioInline1" name="customRadioInline1" class="custom-control-input">
                                                <label class="custom-control-label" for="customRadioInline1">Yes</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input disabled type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input">
                                        ...
                                        <div class="row">
                                            <div class="col form-group mb-4">
                                                <label for="verticalFormStepform-name">Course fee
                                                    (GBP):</label>
                                                <input disabled type="text" class="form-control" id="verticalFormStepform-name" placeholder="">
                                            </div>
                                            <div class="col form-group mb-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col form-group mb-4">
                                                <label for="verticalFormStepform-name">Date of
                                                    Birth:</label>
                                                <input disabled type="date" class="form-control" id="verticalFormStepform-name">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col form-group mb-4">
                                                <label for="verticalFormStepform-name">Email:</label>
                                                <input disabled type="email" class="form-control" id="verticalFormStepform-name">
                                            </div>
                                            <div class="col form-group mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col form-group mb-4">
                                                ...
                                                <div class="form-check">
                                                    <input disabled class="form-check-input" type="checkbox" value="" id="customCheck1">
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="col form-group mb-4">
                                                <label for="verticalFormStepEmailAddress">Mobile No.
                                                    :</label>
                                                <input disabled type="text" class="form-control" id="verticalFormStepEmailAddress" placeholder="">
                                            </div>
                                            <div class="col form-group mb-4">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="div">
                                                <div class="form-check form-check-primary form-check-inline">
                                                    <input disabled class="form-check-input" type="radio" name="flexRadioDefault" id="form-check-radio-primary" checked="">
                                                ...
                                                <div class="form-check form-check-info form-check-inline">
                                                    <input disabled class="form-check-input" type="radio" name="flexRadioDefault" id="form-check-radio-info">
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="verticalFormStepform-name">Unique Learner Number
                                                (ULN):</label>
                                            <input disabled type="text" class="form-control" id="verticalFormStepform-name">
                                        </div>
                                        <div class="row">
                                            <div class="col form-group mb-4">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="col form-group mb-4">
                                                            ...
                                                            <input disabled type="file" class="form-control-file" id="exampleFormControlFile1">
                                                        </div>
                                                        <div class="col form-group mb-4">
                                ...
                                <div id="verticalFormStep-five" class="content" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="col-2 form-group mb-4">
                                            <label for="verticalFormStepform-name">Title:</label>
                                            <select disabled id="inputState" class="form-select" disabled>
                                                <option selected>Mr.</option>
                                            </select>
                                        </div>
                                        <div class="col-5 form-group mb-4">
                                            <label for="verticalFormStepform-name">First name:</label>
                                            <input disabled type="text" class="form-control" id="verticalFormStepform-name" placeholder="" value="Riazul" disabled>
                                        </div>
                                        <div class="col-5 form-group mb-4">
                                            <label for="verticalFormStepform-name">Last name:</label>
                                            <input disabled type="text" class="form-control" id="verticalFormStepform-name" placeholder="" value="Islam" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col form-group mb-4">
                                        ...
                                        <div class="col form-group mb-4">
                                            <label for="verticalFormStepform-name">Date of
                                                Birth:</label>
                                            <input disabled type="text" class="form-control" id="verticalFormStepform-name" value="05/04/2023" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col form-group mb-4">
                                            <label for="verticalFormStepform-name">Email:</label>
                                            <input disabled type="email" class="form-control" id="verticalFormStepform-name" value="riazul@gmail.com" disabled>
                                        </div>
                                        <div class="col form-group mb-4">
                                            <label for="verticalFormStepform-name">Confirm
                                                Email:</label>
                                ...
                                <div id="verticalFormStep-Six" class="content" role="tabpanel">
                                    ...
                                    <form class="row g-3">
                                        <div class="col-6">
                                            ...
                                            <input disabled type="date" class="form-control" id="verticalFormInputAddress">
                                        </div>
                                        <div class="col-6">
                                            <label for="verticalFormInputAddress2" class="form-label">Interview Time :</label>
                                            <input disabled type="time" class="form-control" id="verticalFormInputAddress2" placeholder="Apartment, studio, or floor">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="verticalFormStepInputCity" class="form-label">Results :</label>
                                            <input disabled type="text" class="form-control" id="verticalFormStepInputCity">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="verticalFormStepInputState" class="form-label">No Show :</label>
                                            <select disabled id="verticalFormStepInputState" class="form-select">
                                                <option selected="">Choose...</option>
                                                <option>No</option>
                                                <option>Yes</option>
                                            </select>

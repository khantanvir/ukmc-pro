                            ...
                            <div class="row mb-4">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <h4>Admission Officer Information</h4><a href="/Officers" class=""><button
                                                class="btn btn-info btn-rounded mb-2 mr-4 inline-flex items-center"> View
                                                Officers <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                ...
                                <div class="col">
                                    <div class="form-group mb-4"><label for="exampleFormControlInput1">Officer for
                                            Campus</label><select class="form-control">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-group mb-4"><label for="exampleFormControlInput1">National ID or
                                            Passport</label><input type="text" class="form-control">
                                        <!---->
                                    </div>
                                </div>
                                <div class="col">
                            ...
                            <div class="row mb-4">
                                <div class="col">
                                    <div class="form-group mb-4"><label
                                            ...
                                            <option value="118">Korea, Democratic People's Republic
                                                of</option>
                                            ...
                                            <option value="186">Saint Helena, Ascension and Tristan
                                                da Cunha</option>
                                            ...
                                            <option value="237">United States Minor Outlying Islands
                                            </option>
                            ...
                            <div class="row mb-4">
                                <div class="col col-md-8">
                                    <div class="form-group mb-4"><label for="exampleFormControlTextarea1">Address in
                                            Details</label>
                                        <textarea id="exampleFormControlTextarea1" class="form-control" rows="1" spellcheck="false"></textarea>
                                        <!---->
                                    </div>
                                </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-group mb-4"><label for="email">Email</label><input type="email"
                                            class="form-control"><span class="form-text text-danger">Officer email must be
                                            matched with Officer
                                            email</span></div>
                                </div>
                                <div class="col">

                            ...
                            <div class="row mb-4">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <h4>Teacher Information</h4><a href="/Teachers" class=""><button
                                                class="btn btn-info btn-rounded mb-2 mr-4 inline-flex items-center"> View
                                                Teachers <svg xmlns="http://www.w3.org/2000/svg" width="20"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col col-md-4">
                                    <div class="row d-flex align-items-center">
                                        <div class="col col-md-8">
                                            <div class="form-group mb-4"><label>Upload Teacher Photo</label><label
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-group mb-4"><label for="email">Email</label><input type="email"
                                            class="form-control"><span class="form-text text-danger">Teacher email must be
